...
Во-первых, кому задать вопрос? Без потери общности положим, что вопрос
...
компьютеров через "или":

~~~
Верно ли, что 1-А, 2-С, 3-В или 1-В, 2-С, 3-А?
~~~

Теперь, если мы переберем все возможные подмножества (их _2^(3!)_)
множества возможных конфигураций (их _3!_), то получим все возможные
